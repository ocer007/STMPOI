...
class SimpleTransformerEncoderLayer(nn.Module):
    ...
    def forward(self, src, src_mask=None, src_key_padding_mask=None, is_causal=False):
        ...
        attn_output, _ = self.self_attn(src, attn_mask=src_mask, key_padding_mask=src_key_padding_mask)
...
class TransformerModel1(nn.Module):
    def __init__(self, num_poi, num_cat, embed_size, nhead, nhid, nlayers, dropout=0.5):
        ...
        encoder_layers = SimpleTransformerEncoderLayer(embed_size, nhead, nhid, dropout, batch_first=True)
